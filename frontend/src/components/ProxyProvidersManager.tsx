...
import { X, Plus, Pencil, Trash2, Server } from "lucide-react";
      ...
      <div className="bg-surface-1 border border-border rounded-lg w-full max-w-lg shadow-xl">
        <div className="flex items-center justify-between px-4 py-3 border-b border-border">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-semibold">Proxy Providers</h2>
          </div>
          ...
          {providers.map((p) => (
            ...
            >
              ...
              <div className="flex items-center gap-1 ml-2">
                <button onClick={() => handleEdit(p)} className="p-1 text-gray-500 hover:text-gray-300" title="Edit">
                  <Pencil className="h-3.5 w-3.5" />
                </button>
                <button onClick={() => handleDelete(p.id)} className="p-1 text-gray-500 hover:text-red-400" title="Delete">
